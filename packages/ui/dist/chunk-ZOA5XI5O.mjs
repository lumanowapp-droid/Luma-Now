...
var init_colors = __esm({
  "src/tokens/colors.ts"() {
    ...
    baseColors = {
      // Light mode
      bgLight: "hsl(210, 40%, 98%)",
      // #F8FAFC - Clean white
      bgDark: "hsl(222, 84%, 5%)",
      // #0F172A - Professional dark
      textPrimary: "hsl(222, 84%, 5%)",
      // #0F172A - Professional text
      textPrimaryLight: "hsl(222, 84%, 5%)",
      // #0F172A
      textPrimaryDark: "hsl(210, 40%, 98%)",
      // #F8FAFC
    ...
    semanticColors = {
      ...
      // Professional amber
      // State colors (professional feedback)
      success: "hsl(142, 71%, 45%)",
